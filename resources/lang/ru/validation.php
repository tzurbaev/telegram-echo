...
return [
    ...
    */
    ...
    'bot_token'            => 'Поле :attribute должно иметь значение корректного токена Бота.',
    'chat_identifier'      => 'Поле :attribute должно иметь значение корректного идентификатора чата.',
